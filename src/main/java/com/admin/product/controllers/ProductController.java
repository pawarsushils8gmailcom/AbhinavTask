...
public class ProductController {
	...
	@GetMapping("/doLogin")
	@ResponseBody
	public ResponseEntity<Object> doLogin(@RequestParam String userName,String password)
	{
		return service.doLogin(userName, password);
	}
	
	@PostMapping("/registerUser")
	public ResponseEntity<Object> saveProduct2(@RequestBody UserPojo pojo)
	{
		return service.registerUser(pojo);
	}
